          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
            ...
            <section>
              ...
              <p>
                ...
                <a href="https://www.instagram.com/reinwerk_service" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">
                  https://www.instagram.com/reinwerk_service
                </a>
              </p>
            </section>
