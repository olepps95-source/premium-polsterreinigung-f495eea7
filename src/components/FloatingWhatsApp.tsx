...
export const FloatingWhatsApp = () => {
  ...
  return (
    <div className="fixed bottom-[calc(env(safe-area-inset-bottom,16px)+16px)] right-4 z-50">
      ...
      >
        WhatsApp schreiben
        <div className="absolute top-full right-4 w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[6px] border-t-anthracite" />
      </div>
      
      {/* Button */}
      <a
        href="https://wa.me/491636986317?text=Hallo%21%20Ich%20habe%20Ihre%20Website%20besucht%20und%20interessiere%20mich%20f%C3%BCr%20eine%20Polsterreinigung.%20Gerne%20sende%20ich%20Ihnen%20Fotos%20zur%20Einsch%C3%A4tzung."
        target="_blank"
