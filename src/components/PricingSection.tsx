      ...
      <div className="container">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <button 
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-3 md:px-8 md:py-4 bg-[#25D366] hover:bg-[#20BD5A] active:scale-[0.98] text-white font-semibold text-sm md:text-lg rounded-xl shadow-lg transition-all duration-200"
          >
            <svg 
