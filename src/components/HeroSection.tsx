    ...
    <section className="relative min-h-screen flex items-center justify-start md:items-center pt-20 pb-safe overflow-hidden">
      ...
      <div className="container relative z-10 py-32">
        <div className="max-w-2xl text-left">
          <h1 className="text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6 animate-fade-up" style={{ animationDelay: '0.1s' }}>
            <span className="inline">Premium</span>{' '}
            <span className="text-primary inline">Polsterreinigung</span>{' '}
            <span className="inline">direkt bei Ihnen</span>{' '}
            <span className="inline">vor Ort</span>
          </h1>
